...
public class FiscalserviceTest {
	...
	public void testSignedXML() throws Exception {
		...
		//System.setProperty("javax.net.ssl.trustStrore", "C:/Program Files/Java/jre6/lib/security/cacerts");
		//System.setProperty("javax.net.ssl.trustStorePassword", "changeit");
		//Certificate issued to Krunoslav Hrnjak
		KeyStore.PrivateKeyEntry pke01=KeyManager.getPrivateKeyEntry("./key_folder/fiskaltest0.pfx","fiskaltest");
		...
		rz01 = (RacunZahtjev)  Signer.getSignedObject(rz01,pke02);
		ro = fpt.racuni(rz01);	
		...
		ppz = (PoslovniProstorZahtjev) Signer.getSignedObject(ppz,pke02);			
