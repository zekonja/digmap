...
public class Config implements Closeable {
    ...
    //additional configuration for DigMap
    private Properties configDM;

    public Properties getConfigDM() {
		return configDM;
	}

	public void setConfigDM(Properties configDM) {
		this.configDM = configDM;
	}
	
	public void setConfigDM(String configDMPath) {		
		try {
			Properties properties = new Properties();
			properties.load(new FileInputStream(configDMPath));
			this.configDM = properties;
    ...
    private String outputFilename = "MPF-DigMap.pdf";
